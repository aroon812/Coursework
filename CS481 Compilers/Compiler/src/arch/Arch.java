...
/**
 * Arch classes describe the details of a specific architecture. This abstract
 * base class specifies the functionality that all such architecture-specific
 * classes must have, incuding symbolic names for specific registers, arrays of
 * caller- and callee-saved registers on the specific machine, and the names of
...
public abstract class Arch {
	...
	/** Return an array of the callee-saved registers for a given architecture. */
	abstract public Reg[] calleeSaved();

	/** Return an array of the caller-saved registers for a given architecture. */
