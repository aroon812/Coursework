...
public final class AWhileStmt extends PStmt {
	...
	public AWhileStmt(@SuppressWarnings("hiding") PExp _exp_,
	...
	@Override
	public Object clone() {
		return new AWhileStmt(cloneNode(this._exp_), cloneNode(this._stmt_));
	}
	...
	public String toString() {
		return "" + toString(this._exp_) + toString(this._stmt_);
	}
