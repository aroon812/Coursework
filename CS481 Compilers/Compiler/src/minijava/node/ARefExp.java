...
public final class ARefExp extends PExp {
	...
	public ARefExp(@SuppressWarnings("hiding") PExp _name_,
	...
	@Override
	public Object clone() {
		return new ARefExp(cloneNode(this._name_), cloneNode(this._idx_));
	}
	...
	public String toString() {
		return "" + toString(this._name_) + toString(this._idx_);
	}
