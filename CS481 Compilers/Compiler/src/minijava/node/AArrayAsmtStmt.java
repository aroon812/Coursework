...
public final class AArrayAsmtStmt extends PStmt {
	...
	public AArrayAsmtStmt(@SuppressWarnings("hiding") TId _id_,
	...
	@Override
	public Object clone() {
		return new AArrayAsmtStmt(cloneNode(this._id_), cloneNode(this._idx_),
	...
	public String toString() {
		return "" + toString(this._id_) + toString(this._idx_)
				+ toString(this._val_);
	}
