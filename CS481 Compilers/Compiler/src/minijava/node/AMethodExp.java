...
public final class AMethodExp extends PExp {
	...
	public AMethodExp(@SuppressWarnings("hiding") PExp _obj_,
	...
	@Override
	public Object clone() {
		return new AMethodExp(cloneNode(this._obj_), cloneNode(this._id_),
	...
	public String toString() {
		return "" + toString(this._obj_) + toString(this._id_)
