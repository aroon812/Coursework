...
public final class ABaseClassDecl extends PClassDecl {
	...
	public ABaseClassDecl(@SuppressWarnings("hiding") TId _id_,
	...
	@Override
	public Object clone() {
		return new ABaseClassDecl(cloneNode(this._id_),
				cloneList(this._varDecl_), cloneList(this._method_));
	}
	...
	public String toString() {
		return "" + toString(this._id_) + toString(this._varDecl_)
