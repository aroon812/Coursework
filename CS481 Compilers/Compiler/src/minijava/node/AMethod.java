...
public final class AMethod extends PMethod {
	...
	public AMethod(@SuppressWarnings("hiding") PType _type_,
	...
	@Override
	public Object clone() {
		return new AMethod(cloneNode(this._type_), cloneNode(this._id_),
				cloneList(this._formal_), cloneList(this._varDecl_),
	...
	public String toString() {
		return "" + toString(this._type_) + toString(this._id_)
				+ toString(this._formal_) + toString(this._varDecl_)
	...
	void replaceChild(@SuppressWarnings("unused") Node oldChild,
		...
		for (ListIterator<PFormal> i = this._formal_.listIterator(); i
				.hasNext();) {
			if (i.next() == oldChild) {
				if (newChild != null) {
		...
		for (ListIterator<PVarDecl> i = this._varDecl_.listIterator(); i
				.hasNext();) {
			if (i.next() == oldChild) {
				if (newChild != null) {
