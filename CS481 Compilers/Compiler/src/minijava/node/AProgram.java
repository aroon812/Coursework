...
public final class AProgram extends PProgram {
	...
	public AProgram(@SuppressWarnings("hiding") List<?> _classDecl_) {
		// Constructor
	...
	@Override
	public Object clone() {
		return new AProgram(cloneList(this._classDecl_));
	}
	...
	public String toString() {
		return "" + toString(this._classDecl_);
	}
	...
	void replaceChild(@SuppressWarnings("unused") Node oldChild,
		...
		// Replace child
		for (ListIterator<PClassDecl> i = this._classDecl_.listIterator(); i
				.hasNext();) {
			if (i.next() == oldChild) {
				if (newChild != null) {
