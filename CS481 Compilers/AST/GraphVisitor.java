/**
 * This is really just ParserDot with a new name. The main difference
 * is that we now look for the root of the AST rather than the CST
 * when starting to visit. Also, we expect input on System.in rather
 * than building in a test program.
 */
