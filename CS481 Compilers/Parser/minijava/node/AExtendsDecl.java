...
public final class AExtendsDecl extends PExtendsDecl
{
    ...
    public AExtendsDecl(
        ...
        @SuppressWarnings("hiding") TId _name1_,
    ...
    {
        ((Analysis) sw).caseAExtendsDecl(this);
    }
